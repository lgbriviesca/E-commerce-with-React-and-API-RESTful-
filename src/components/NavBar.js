    ...
    <div className='nav-bar'>
      ...
      <nav className='nav-main'>
        <section className="title" >
          ...
          <Link onClick={() => dispatch(getProductsThunk())} className="link-title" to={`/`}>e-commerce</Link>
        </section>
      ...
      <button onClick={openCart}> <i className="fa-solid fa-cart-shopping"></i> </button> 
          ...
          <div className='buttons-container'>
            <button> <Link className='link-purchases' to={`/purchases`}> <i className="fa-solid fa-box-open"></i> </Link> </button>
          </div>
      ...
      <div className='log-in-container'>
        <form onSubmit={login} className={`login ${isLoginOpen ? "open" : ""}`}>
          <p className='profile-character' ><i className="fa-solid fa-circle-user"></i></p>
